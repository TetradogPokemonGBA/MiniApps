...
namespace MiniApps
{
	...
	public partial class Window1 : Window
	{
		...
		const string MENSAJEOBJETORECIVIDOCONIMAGEN="MensajeObjetoRecividoConImagen";
		...
		static readonly string[] MiniApps={SISTEMAMTBW,SCRIPTSDEGATILLOCONDICIONMAYORAFF,QUITARTUTORIALBATALLAOAK,QUITARSISTEMADEAYUDAROJOYVERDE,QUITARDIARIOPARTIDA,MOSINMEDALAS,BORRARMOS,IMPEDIRCAPTURAVIASCRIPT,GANAREXPERIENCIAALCAPTURARUNPOKEMON,EVOLUCIONARSINNATIONALDEX,DESACTIVARANIMACIONMTMO,MENSAJEOBJETORECIVIDOCONIMAGEN};
